...
public class PolishedBlackstoneBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:polished_blackstone")
	public static final Block block = null;
	public PolishedBlackstoneBlock(SgeorsgeModElements instance) {
		super(instance, 48);
	}
