...
import net.mcreator.sgeorsge.procedures.RicePlantPlantDestroyedByPlayerProcedure;
import net.mcreator.sgeorsge.item.RiceSeedItem;
...
public class RicePlantBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:rice_plant")
	public static final Block block = null;
	public RicePlantBlock(SgeorsgeModElements instance) {
		super(instance, 40);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RiceSeedItem.block, (int) (1)));
		}
		...
		public void onBlockClicked(BlockState state, World world, BlockPos pos, PlayerEntity entity) {
			...
			int z = pos.getZ();
			{
				...
				RicePlantPlantDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
