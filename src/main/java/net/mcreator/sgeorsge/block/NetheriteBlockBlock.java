...
public class NetheriteBlockBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:netherite_block")
	public static final Block block = null;
	public NetheriteBlockBlock(SgeorsgeModElements instance) {
		super(instance, 52);
	}
