...
public class PolishedBlackstoneBricksBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:polished_blackstone_bricks")
	public static final Block block = null;
	public PolishedBlackstoneBricksBlock(SgeorsgeModElements instance) {
		super(instance, 47);
	}
