...
public class AncientDebrisBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:ancient_debris")
	public static final Block block = null;
	public AncientDebrisBlock(SgeorsgeModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(30f, 1200f).lightValue(0).harvestLevel(3)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 2)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(1, 8, 8, 22))));
		}
	}
}
