...
public class BlackstoneBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:blackstone")
	public static final Block block = null;
	public BlackstoneBlock(SgeorsgeModElements instance) {
		super(instance, 46);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 16)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(5, 0, 0, 90))));
		}
	}
}
