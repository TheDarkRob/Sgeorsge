...
public class GildedBlackstoneBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:gilded_blackstone")
	public static final Block block = null;
	public GildedBlackstoneBlock(SgeorsgeModElements instance) {
		super(instance, 49);
	}
