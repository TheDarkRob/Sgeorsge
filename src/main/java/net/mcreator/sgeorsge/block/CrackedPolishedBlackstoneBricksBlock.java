...
public class CrackedPolishedBlackstoneBricksBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:cracked_polished_blackstone_bricks")
	public static final Block block = null;
	public CrackedPolishedBlackstoneBricksBlock(SgeorsgeModElements instance) {
		super(instance, 50);
	}
