...
import net.mcreator.sgeorsge.procedures.CrusherUpdateTickProcedure;
import net.mcreator.sgeorsge.itemgroup.SgeorsgeDuplicatioItemGroup;
import net.mcreator.sgeorsge.gui.CrusherGUIGui;
...
public class CrusherBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:crusher")
	public static final Block block = null;
	@ObjectHolder("sgeorsge:crusher")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CrusherBlock(SgeorsgeModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new BlockItem(block, new Item.Properties().group(SgeorsgeDuplicatioItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
