...
import net.mcreator.sgeorsge.procedures.NetherGoldOreBlockDestroyedByPlayerProcedure;
...
public class NetherGoldOreBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:nether_gold_ore")
	public static final Block block = null;
	public NetherGoldOreBlock(SgeorsgeModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				NetherGoldOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
