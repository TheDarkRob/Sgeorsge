...
public class ChiseledPolishedBlackstoneBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:chiseled_polished_blackstone")
	public static final Block block = null;
	public ChiseledPolishedBlackstoneBlock(SgeorsgeModElements instance) {
		super(instance, 51);
	}
