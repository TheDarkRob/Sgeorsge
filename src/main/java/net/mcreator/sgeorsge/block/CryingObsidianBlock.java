...
public class CryingObsidianBlock extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:crying_obsidian")
	public static final Block block = null;
	public CryingObsidianBlock(SgeorsgeModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.MISCELLANEOUS).sound(SoundType.STONE).hardnessAndResistance(50f, 1200f).lightValue(11)
