...
public class LapisLazuliDustItem extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:lapis_lazuli_dust")
	public static final Item block = null;
	public LapisLazuliDustItem(SgeorsgeModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lapis_lazuli_dust");
		}
