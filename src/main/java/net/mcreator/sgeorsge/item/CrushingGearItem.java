...
public class CrushingGearItem extends SgeorsgeModElements.ModElement {
	@ObjectHolder("sgeorsge:crushing_gear")
	public static final Item block = null;
	public CrushingGearItem(SgeorsgeModElements instance) {
		super(instance, 3);
	}
